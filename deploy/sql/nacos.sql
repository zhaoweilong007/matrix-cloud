...
VALUES (1, 'gateway-route', 'DEFAULT_GROUP', '[]', 'd751713988987e9331980363e24189ce', '2022-07-04 06:24:38',
       ...
       (27, 'matrix-security', 'DEFAULT_GROUP',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-07-29 07:28:54', '2022-10-26 14:04:56', NULL, '172.21.0.2', '', '',
       ...
       (645, 'api-gateway.yml', 'DEFAULT_GROUP',
        ...
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-25 09:14:35', '2022-10-25 09:14:35', NULL, '192.168.96.1', '', '',
        NULL, NULL, NULL, 'yaml', NULL, '');
/*!40000 ALTER TABLE `config_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (27, 596, 'matrix-security', 'DEFAULT_GROUP', '',
       ...
       (27, 798, 'matrix-security', 'DEFAULT_GROUP', '',
        ...
        ''),
       (27, 799, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:02:21', '2022-10-24 16:02:22', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 800, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 16:04:31', '2022-10-24 16:04:31', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 801, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:07:38', '2022-10-24 16:07:38', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 802, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:17:48', '2022-10-24 16:17:48', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 803, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:18:21', '2022-10-24 16:18:22', NULL, '192.168.2.36', 'U', '',
        ''),
       (484, 804, 'application-common', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: true\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true',
        '6e5ee18648390d8bb1a6888f37b63876', '2022-10-24 16:22:45', '2022-10-24 16:22:46', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 805, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 16:23:29', '2022-10-24 16:23:29', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 806, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:24:02', '2022-10-24 16:24:03', NULL, '192.168.2.36', 'U', '',
        ''),
       (564, 807, 'system-server-dev.yaml', 'DEFAULT_GROUP', '',
        ...
        '67485eb5a4f032cd574faf15653fb5fb', '2022-10-24 16:31:27', '2022-10-24 16:31:28', NULL, '192.168.96.1', 'D', '',
        ''),
       (27, 808, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:31:58', '2022-10-24 16:31:59', NULL, '192.168.2.36', 'U', '',
        ''),
       (484, 809, 'application-common', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: true\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: abcdefghijklmnopqrstuvwxyz\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true',
        '34c5a5af1226079ffa23d304a777207f', '2022-10-24 16:44:40', '2022-10-24 16:44:40', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 810, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:45:13', '2022-10-24 16:45:13', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 811, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 16:53:02', '2022-10-24 16:53:02', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 812, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 17:14:45', '2022-10-24 17:14:46', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 813, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /system-server/nacos/**, /api-gateway/docapp/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '39dd7e34946efbe24b78dd7c98c69022', '2022-10-24 17:16:04', '2022-10-24 17:16:04', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 814, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 17:17:29', '2022-10-24 17:17:29', NULL, '192.168.2.36', 'U', '',
        ''),
       (484, 815, 'application-common', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: true\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: abcdefghijklmnopqrstuvwxyz\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\ndemo:\n  name: 张三\n  desc: 测试',
        'd7d1e794a67452244ee11eea9f5dac84', '2022-10-24 17:24:24', '2022-10-24 17:24:24', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (0, 816, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\r\n  main:\r\n    allow-bean-definition-overriding: true\r\n  servlet:\r\n    multipart:\r\n      max-request-size: 5MB\r\n      max-file-size: 100MB\r\n  jackson:\r\n    time-zone: GMT+8\r\n    date-format: yyyy-MM-dd HH:mm:ss\r\n    serialization:\r\n      # 格式化输出\r\n      INDENT_OUTPUT: false\r\n      # 忽略无法转换的对象\r\n      fail_on_empty_beans: false\r\n    deserialization:\r\n      # 允许对象忽略json中不存在的属性\r\n      fail_on_unknown_properties: false\r\n  datasource:\r\n    druid:\r\n      initial-size: 5 # 初始连接数\r\n      min-idle: 10 # 最小连接池数量\r\n      max-active: 20 # 最大连接池数量\r\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\r\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\r\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\r\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\r\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\r\n      test-while-idle: true\r\n      test-on-borrow: false\r\n      test-on-return: false\r\n      web-stat-filter:\r\n        enabled: true\r\n      stat-view-servlet:\r\n        enabled: true\r\n        allow: # 设置白名单，不填则允许所有访问\r\n        url-pattern: /druid/*\r\n        login-username: druid\r\n        login-password: druid\r\n      filter:\r\n        stat:\r\n          enabled: true\r\n          log-slow-sql: true # 慢 SQL 记录\r\n          slow-sql-millis: 100\r\n          merge-sql: true\r\n        wall:\r\n          config:\r\n            multi-statement-allow: true\r\n\r\nfeign:\r\n  ## 启用对 feign 的 Sentinel 支持\r\n  sentinel:\r\n    enabled: true\r\n  client:\r\n    config:\r\n      default:\r\n        connect-timeout: 5000\r\n        read-timeout: 5000\r\n        logger-level: full\r\n  autoconfiguration:\r\n    jackson:\r\n      enabled: true\r\n  compression:\r\n    request:\r\n      enabled: true\r\n    response:\r\n      enabled: true\r\n  metrics:\r\n    enabled: true\r\n\r\n\r\n# 文档配置\r\nknife4j:\r\n  enable: true\r\n  production: false\r\n  cors: true\r\n\r\n# mybatis plus配置\r\nmybatis-plus:\r\n  global-config:\r\n    db-config:\r\n      id-type: auto\r\n  configuration:\r\n    map-underscore-to-camel-case: true\r\n    call-setters-on-nulls: true\r\n  check-config-location: false\r\n\r\n\r\nsa-token:\r\n  # jwt秘钥\r\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\r\n  # token名称 (同时也是cookie名称)\r\n  token-name: Authorization\r\n  # token有效期，单位s 默认30天, -1代表永不过期\r\n  timeout: 2592000\r\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\r\n  activity-timeout: 1800\r\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\r\n  is-concurrent: true\r\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\r\n  is-share: true\r\n  # token风格\r\n  token-style: uuid\r\n  # 是否输出操作日志\r\n  is-log: true',
        '4409a0819859178823962993fd673a6d', '2022-10-24 17:31:48', '2022-10-24 17:31:48', NULL, '192.168.96.1', 'I', '',
        ''),
       (619, 817, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\r\n  main:\r\n    allow-bean-definition-overriding: true\r\n  servlet:\r\n    multipart:\r\n      max-request-size: 5MB\r\n      max-file-size: 100MB\r\n  jackson:\r\n    time-zone: GMT+8\r\n    date-format: yyyy-MM-dd HH:mm:ss\r\n    serialization:\r\n      # 格式化输出\r\n      INDENT_OUTPUT: false\r\n      # 忽略无法转换的对象\r\n      fail_on_empty_beans: false\r\n    deserialization:\r\n      # 允许对象忽略json中不存在的属性\r\n      fail_on_unknown_properties: false\r\n  datasource:\r\n    druid:\r\n      initial-size: 5 # 初始连接数\r\n      min-idle: 10 # 最小连接池数量\r\n      max-active: 20 # 最大连接池数量\r\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\r\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\r\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\r\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\r\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\r\n      test-while-idle: true\r\n      test-on-borrow: false\r\n      test-on-return: false\r\n      web-stat-filter:\r\n        enabled: true\r\n      stat-view-servlet:\r\n        enabled: true\r\n        allow: # 设置白名单，不填则允许所有访问\r\n        url-pattern: /druid/*\r\n        login-username: druid\r\n        login-password: druid\r\n      filter:\r\n        stat:\r\n          enabled: true\r\n          log-slow-sql: true # 慢 SQL 记录\r\n          slow-sql-millis: 100\r\n          merge-sql: true\r\n        wall:\r\n          config:\r\n            multi-statement-allow: true\r\n\r\nfeign:\r\n  ## 启用对 feign 的 Sentinel 支持\r\n  sentinel:\r\n    enabled: true\r\n  client:\r\n    config:\r\n      default:\r\n        connect-timeout: 5000\r\n        read-timeout: 5000\r\n        logger-level: full\r\n  autoconfiguration:\r\n    jackson:\r\n      enabled: true\r\n  compression:\r\n    request:\r\n      enabled: true\r\n    response:\r\n      enabled: true\r\n  metrics:\r\n    enabled: true\r\n\r\n\r\n# 文档配置\r\nknife4j:\r\n  enable: true\r\n  production: false\r\n  cors: true\r\n\r\n# mybatis plus配置\r\nmybatis-plus:\r\n  global-config:\r\n    db-config:\r\n      id-type: auto\r\n  configuration:\r\n    map-underscore-to-camel-case: true\r\n    call-setters-on-nulls: true\r\n  check-config-location: false\r\n\r\n\r\nsa-token:\r\n  # jwt秘钥\r\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\r\n  # token名称 (同时也是cookie名称)\r\n  token-name: Authorization\r\n  # token有效期，单位s 默认30天, -1代表永不过期\r\n  timeout: 2592000\r\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\r\n  activity-timeout: 1800\r\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\r\n  is-concurrent: true\r\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\r\n  is-share: true\r\n  # token风格\r\n  token-style: uuid\r\n  # 是否输出操作日志\r\n  is-log: true',
        '4409a0819859178823962993fd673a6d', '2022-10-24 17:32:38', '2022-10-24 17:32:38', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 818, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-24 17:33:24', '2022-10-24 17:33:25', NULL, '192.168.2.36', 'U', '',
        ''),
       (619, 819, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: true\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\ndemo:\n  name: 张三\n  desc: 你好',
        '335a4b9f9754762821a7adc90e54d547', '2022-10-24 17:38:42', '2022-10-24 17:38:42', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 820, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-24 17:54:16', '2022-10-24 17:54:16', NULL, '192.168.2.36', 'U', '',
        ''),
       (484, 821, 'application-common', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: true\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true',
        '6e5ee18648390d8bb1a6888f37b63876', '2022-10-24 17:54:51', '2022-10-24 17:54:51', NULL, '192.168.96.1', 'D', '',
        ''),
       (27, 822, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 17:55:10', '2022-10-24 17:55:11', NULL, '192.168.2.36', 'U', '',
        ''),
       (0, 823, 'api-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\r\n  cloud:\r\n    ## sentinel配置\r\n    sentinel:\r\n      filter:\r\n        enabled: false\r\n      scg:\r\n        fallback:\r\n          content-type: application/json\r\n          mode: response\r\n          response-status: 429\r\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\r\n      datasource:\r\n        gw-flow:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-flow\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_flow\r\n        gw-api-group:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-api-group\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_api_group\r\n    ## gateway配置\r\n    gateway:\r\n      globalcors:\r\n        ## 配置跨域\r\n        cors-configurations:\r\n          \'[/**]\':\r\n            allowed-origins: \"*\"\r\n            allowed-methods: \"*\"\r\n            allowed-headers: \"*\"\r\n      discovery:\r\n        locator:\r\n          enabled: true\r\n          lower-case-service-id: true\r\n          url-expression: \"\'grayLb://\'+serviceId\"\r\n      loadbalancer:\r\n        use404: true',
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-24 17:56:59', '2022-10-24 17:57:00', NULL, '192.168.96.1', 'I', '',
        ''),
       (494, 824, 'api-gateway', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    sentinel:\n      filter:\n        enabled: false\n      scg:\n        fallback:\n          content-type: application/json\n          mode: response\n          response-status: 429\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\n      datasource:\n        gw-flow:\n          nacos:\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n            username: ${NACOS_USERNAME:nacos}\n            password: ${NACOS_PASSWD:nacos}\n            data-id: gateway-flow\n            group-id: DEFAULT_GROUP\n            data-type: json\n            rule-type: gw_flow\n        gw-api-group:\n          nacos:\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n            username: ${NACOS_USERNAME:nacos}\n            password: ${NACOS_PASSWD:nacos}\n            data-id: gateway-api-group\n            group-id: DEFAULT_GROUP\n            data-type: json\n            rule-type: gw_api_group\n    gateway:\n      globalcors:\n        cors-configurations:\n          \'[/**]\':\n            allowed-origins: \"*\"\n            allowed-methods: \"*\"\n            allowed-headers: \"*\"\n      discovery:\n        locator:\n          enabled: true\n          lower-case-service-id: true\n          url-expression: \"\'grayLb://\'+serviceId\"\n      loadbalancer:\n        use404: true',
        '457060057987b7e12bb8e840f95d79aa', '2022-10-24 17:57:26', '2022-10-24 17:57:27', NULL, '192.168.96.1', 'D', '',
        ''),
       (27, 825, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-24 17:57:30', '2022-10-24 17:57:31', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 826, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 17:59:19', '2022-10-24 17:59:19', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 827, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 18:02:36', '2022-10-24 18:02:36', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 828, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 18:03:34', '2022-10-24 18:03:35', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 829, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-24 18:04:15', '2022-10-24 18:04:15', NULL, '192.168.2.36', 'U', '',
        ''),
       (0, 830, 'api-gateway.yaml', 'DEFAULT_GROUP', '',
        'spring:\r\n  cloud:\r\n    ## sentinel配置\r\n    sentinel:\r\n      filter:\r\n        enabled: false\r\n      scg:\r\n        fallback:\r\n          content-type: application/json\r\n          mode: response\r\n          response-status: 429\r\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\r\n      datasource:\r\n        gw-flow:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-flow\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_flow\r\n        gw-api-group:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-api-group\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_api_group\r\n    ## gateway配置\r\n    gateway:\r\n      globalcors:\r\n        ## 配置跨域\r\n        cors-configurations:\r\n          \'[/**]\':\r\n            allowed-origins: \"*\"\r\n            allowed-methods: \"*\"\r\n            allowed-headers: \"*\"\r\n      discovery:\r\n        locator:\r\n          enabled: true\r\n          lower-case-service-id: true\r\n          url-expression: \"\'grayLb://\'+serviceId\"\r\n      loadbalancer:\r\n        use404: true',
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-24 18:05:46', '2022-10-24 18:05:46', NULL, '192.168.96.1', 'I', '',
        ''),
       (625, 831, 'api-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\r\n  cloud:\r\n    ## sentinel配置\r\n    sentinel:\r\n      filter:\r\n        enabled: false\r\n      scg:\r\n        fallback:\r\n          content-type: application/json\r\n          mode: response\r\n          response-status: 429\r\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\r\n      datasource:\r\n        gw-flow:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-flow\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_flow\r\n        gw-api-group:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-api-group\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_api_group\r\n    ## gateway配置\r\n    gateway:\r\n      globalcors:\r\n        ## 配置跨域\r\n        cors-configurations:\r\n          \'[/**]\':\r\n            allowed-origins: \"*\"\r\n            allowed-methods: \"*\"\r\n            allowed-headers: \"*\"\r\n      discovery:\r\n        locator:\r\n          enabled: true\r\n          lower-case-service-id: true\r\n          url-expression: \"\'grayLb://\'+serviceId\"\r\n      loadbalancer:\r\n        use404: true',
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-24 18:05:52', '2022-10-24 18:05:53', NULL, '192.168.96.1', 'D', '',
        ''),
       (27, 832, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 18:06:20', '2022-10-24 18:06:20', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 833, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 18:25:41', '2022-10-24 18:25:42', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 834, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-24 18:26:44', '2022-10-24 18:26:45', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 835, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-24 18:28:39', '2022-10-24 18:28:40', NULL, '192.168.2.36', 'U', '',
        ''),
       (619, 836, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: ${matrix.swagger.enable:true}\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\ndemo:\n  name: 张三\n  desc: 你好',
        '32ae6b14f61fa958d3a56931bd65c36f', '2022-10-24 18:29:58', '2022-10-24 18:29:59', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 837, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:01:05', '2022-10-25 09:01:05', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 838, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:04:20', '2022-10-25 09:04:20', NULL, '192.168.2.36', 'U', '',
        ''),
       (619, 839, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  messages:\n    basename: i18n/messages\n    encoding: utf-8\n    fallback-to-system-locale: true\n  # redis配置\n  redis:\n    host: ${REDIS_HOST:192.168.2.36}\n    port: ${REDIS_PORT:6379}\n    database: ${REDIS_DATABASE:0}\n    timeout: 10s\n    password: ${REDIS_PASSWORD:matrix}\n    lettuce:\n      pool:\n        # 连接池最大连接数\n        max-active: 200\n        # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms\n        # 连接池中的最大空闲连接\n        max-idle: 10\n        # 连接池中的最小空闲连接\n        min-idle: 0\n  cache:\n    type: redis\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: ${matrix.swagger.enable:true}\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\ndemo:\n  name: 张三\n  desc: 你好',
        '8f7daa74f685960f1afe1addd777b719', '2022-10-25 09:06:16', '2022-10-25 09:06:17', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 840, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:08:46', '2022-10-25 09:08:46', NULL, '192.168.2.36', 'U', '',
        ''),
       (619, 841, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  cloud:\n    sentinel:\n      enabled: true\n      eager: true\n      transport:\n        port: ${SENTINEL_PORT:8719}\n        dashboard: ${SENTINEL_DASHBOARD:localhost:8088}\n  messages:\n    basename: i18n/messages\n    encoding: utf-8\n    fallback-to-system-locale: true\n  # redis配置\n  redis:\n    host: ${REDIS_HOST:192.168.2.36}\n    port: ${REDIS_PORT:6379}\n    database: ${REDIS_DATABASE:0}\n    timeout: 10s\n    password: ${REDIS_PASSWORD:matrix}\n    lettuce:\n      pool:\n        # 连接池最大连接数\n        max-active: 200\n        # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms\n        # 连接池中的最大空闲连接\n        max-idle: 10\n        # 连接池中的最小空闲连接\n        min-idle: 0\n  cache:\n    type: redis\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: ${matrix.swagger.enable:true}\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\ndemo:\n  name: 张三\n  desc: 你好',
        '48326dfdd509722fde6c461c7d287615', '2022-10-25 09:10:48', '2022-10-25 09:10:49', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 842, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:11:19', '2022-10-25 09:11:19', NULL, '192.168.2.36', 'U', '',
        ''),
       (619, 843, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  cloud:\n    sentinel:\n      enabled: true\n      eager: true\n      transport:\n        port: ${SENTINEL_PORT:8719}\n        dashboard: ${SENTINEL_DASHBOARD:localhost:8088}\n  messages:\n    basename: i18n/messages\n    encoding: utf-8\n    fallback-to-system-locale: true\n  # redis配置\n  redis:\n    host: ${REDIS_HOST:192.168.2.36}\n    port: ${REDIS_PORT:6379}\n    database: ${REDIS_DATABASE:0}\n    timeout: 10s\n    password: ${REDIS_PASSWORD:matrix}\n    lettuce:\n      pool:\n        # 连接池最大连接数\n        max-active: 200\n        # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms\n        # 连接池中的最大空闲连接\n        max-idle: 10\n        # 连接池中的最小空闲连接\n        min-idle: 0\n  cache:\n    type: redis\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: ${matrix.swagger.enable:true}\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\nseata:\n  config:\n    type: nacos\n    nacos:\n      server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n      username: ${NACOS_USERNAME:nacos}\n      password: ${NACOS_PASSWD:nacos}\n      group: SEATA_GROUP\n      data-id: seataServer.properties\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n      group: SEATA_GROUP\n      cluster: default\n      username: ${NACOS_USERNAME:nacos}\n      password: ${NACOS_PASSWD:nacos}',
        '422e09da70c00a2b9ed561ad8e3654de', '2022-10-25 09:12:50', '2022-10-25 09:12:50', 'nacos', '192.168.96.1', 'U',
        '', ''),
       (27, 844, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:13:22', '2022-10-25 09:13:22', NULL, '192.168.2.36', 'U', '',
        ''),
       (0, 845, 'api-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\r\n  cloud:\r\n    ## sentinel配置\r\n    sentinel:\r\n      filter:\r\n        enabled: false\r\n      scg:\r\n        fallback:\r\n          content-type: application/json\r\n          mode: response\r\n          response-status: 429\r\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\r\n      datasource:\r\n        gw-flow:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-flow\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_flow\r\n        gw-api-group:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-api-group\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_api_group\r\n    ## gateway配置\r\n    gateway:\r\n      globalcors:\r\n        ## 配置跨域\r\n        cors-configurations:\r\n          \'[/**]\':\r\n            allowed-origins: \"*\"\r\n            allowed-methods: \"*\"\r\n            allowed-headers: \"*\"\r\n      discovery:\r\n        locator:\r\n          enabled: true\r\n          lower-case-service-id: true\r\n          url-expression: \"\'grayLb://\'+serviceId\"\r\n      loadbalancer:\r\n        use404: true',
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-25 09:14:34', '2022-10-25 09:14:35', NULL, '192.168.96.1', 'I', '',
        ''),
       (631, 846, 'api-gateway.yaml', 'DEFAULT_GROUP', '',
        'spring:\r\n  cloud:\r\n    ## sentinel配置\r\n    sentinel:\r\n      filter:\r\n        enabled: false\r\n      scg:\r\n        fallback:\r\n          content-type: application/json\r\n          mode: response\r\n          response-status: 429\r\n          response-body: \'{\"message\":\"Too Many Requests\"}\'\r\n      datasource:\r\n        gw-flow:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-flow\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_flow\r\n        gw-api-group:\r\n          nacos:\r\n            server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\r\n            username: ${NACOS_USERNAME:nacos}\r\n            password: ${NACOS_PASSWD:nacos}\r\n            data-id: gateway-api-group\r\n            group-id: DEFAULT_GROUP\r\n            data-type: json\r\n            rule-type: gw_api_group\r\n    ## gateway配置\r\n    gateway:\r\n      globalcors:\r\n        ## 配置跨域\r\n        cors-configurations:\r\n          \'[/**]\':\r\n            allowed-origins: \"*\"\r\n            allowed-methods: \"*\"\r\n            allowed-headers: \"*\"\r\n      discovery:\r\n        locator:\r\n          enabled: true\r\n          lower-case-service-id: true\r\n          url-expression: \"\'grayLb://\'+serviceId\"\r\n      loadbalancer:\r\n        use404: true',
        '6116fcf3308139842ff4ab7e786a7816', '2022-10-25 09:14:49', '2022-10-25 09:14:49', NULL, '192.168.96.1', 'D', '',
        ''),
       (27, 847, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:15:24', '2022-10-25 09:15:25', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 848, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:17:31', '2022-10-25 09:17:32', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 849, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:18:53', '2022-10-25 09:18:54', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 850, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 09:22:05', '2022-10-25 09:22:06', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 851, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-25 09:27:54', '2022-10-25 09:27:55', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 852, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-25 15:21:38', '2022-10-25 15:21:38', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 853, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-25 15:33:32', '2022-10-25 15:33:32', NULL, '192.168.2.36', 'U', '',
        ''),
       (27, 854, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-26 11:14:26', '2022-10-26 11:14:27', NULL, '172.21.0.12', 'U', '',
        ''),
       (27, 855, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-26 11:27:28', '2022-10-26 11:27:28', NULL, '172.21.0.12', 'U', '',
        ''),
       (27, 856, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-26 13:44:36', '2022-10-26 13:44:37', NULL, '172.21.0.12', 'U', '',
        ''),
       (27, 857, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-26 13:59:11', '2022-10-26 13:59:11', NULL, '172.21.0.13', 'U', '',
        ''),
       (27, 858, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-26 13:59:15', '2022-10-26 13:59:16', NULL, '172.21.0.2', 'U', '',
        ''),
       (619, 859, 'application-common.yml', 'DEFAULT_GROUP', '',
        'spring:\n  main:\n    allow-bean-definition-overriding: true\n  cloud:\n    sentinel:\n      enabled: true\n      eager: true\n      transport:\n        port: ${SENTINEL_PORT:8719}\n        dashboard: ${SENTINEL_DASHBOARD:localhost:8088}\n  messages:\n    basename: i18n/messages\n    encoding: utf-8\n    fallback-to-system-locale: true\n  # redis配置\n  redis:\n    host: ${REDIS_HOST:192.168.2.36}\n    port: ${REDIS_PORT:6379}\n    database: ${REDIS_DATABASE:0}\n    timeout: 10s\n    password: ${REDIS_PASSWORD:matrix}\n    lettuce:\n      pool:\n        # 连接池最大连接数\n        max-active: 200\n        # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms\n        # 连接池中的最大空闲连接\n        max-idle: 10\n        # 连接池中的最小空闲连接\n        min-idle: 0\n  cache:\n    type: redis\n  servlet:\n    multipart:\n      max-request-size: 5MB\n      max-file-size: 100MB\n  jackson:\n    time-zone: GMT+8\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略无法转换的对象\n      fail_on_empty_beans: false\n    deserialization:\n      # 允许对象忽略json中不存在的属性\n      fail_on_unknown_properties: false\n  datasource:\n    druid:\n      initial-size: 5 # 初始连接数\n      min-idle: 10 # 最小连接池数量\n      max-active: 20 # 最大连接池数量\n      max-wait: 600000 # 配置获取连接等待超时的时间，单位：毫秒\n      time-between-eviction-runs-millis: 60000 # 配置间隔多久才进行一次检测，检测需要关闭的空闲连接，单位：毫秒\n      min-evictable-idle-time-millis: 300000 # 配置一个连接在池中最小生存的时间，单位：毫秒\n      max-evictable-idle-time-millis: 900000 # 配置一个连接在池中最大生存的时间，单位：毫秒\n      validation-query: SELECT 1 FROM DUAL # 配置检测连接是否有效\n      test-while-idle: true\n      test-on-borrow: false\n      test-on-return: false\n      web-stat-filter:\n        enabled: true\n      stat-view-servlet:\n        enabled: true\n        allow: # 设置白名单，不填则允许所有访问\n        url-pattern: /druid/*\n        login-username: druid\n        login-password: druid\n      filter:\n        stat:\n          enabled: true\n          log-slow-sql: true # 慢 SQL 记录\n          slow-sql-millis: 100\n          merge-sql: true\n        wall:\n          config:\n            multi-statement-allow: true\n\nfeign:\n  ## 启用对 feign 的 Sentinel 支持\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        connect-timeout: 5000\n        read-timeout: 5000\n        logger-level: full\n  autoconfiguration:\n    jackson:\n      enabled: true\n  compression:\n    request:\n      enabled: true\n    response:\n      enabled: true\n  metrics:\n    enabled: true\n\n\n# 文档配置\nknife4j:\n  enable: ${matrix.swagger.enable:true}\n  production: false\n  cors: true\n\n# mybatis plus配置\nmybatis-plus:\n  global-config:\n    db-config:\n      id-type: auto\n  configuration:\n    map-underscore-to-camel-case: true\n    call-setters-on-nulls: true\n  check-config-location: false\n\n\nsa-token:\n  # jwt秘钥\n  jwt-secret-key: ${SA_TOKEN_JWT_SECRET_KEY:abcdefghijklmnopqrstuvwxyz}\n  # token名称 (同时也是cookie名称)\n  token-name: Authorization\n  # token有效期，单位s 默认30天, -1代表永不过期\n  timeout: 2592000\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\n  activity-timeout: 1800\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\n  is-concurrent: true\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\n  is-share: true\n  # token风格\n  token-style: uuid\n  # 是否输出操作日志\n  is-log: true\n\nseata:\n  config:\n    type: nacos\n    nacos:\n      server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n      username: ${NACOS_USERNAME:nacos}\n      password: ${NACOS_PASSWD:nacos}\n      group: SEATA_GROUP\n      data-id: seataServer.properties\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: ${NACOS_SERVER_ADDRESS:localhost:8848}\n      group: SEATA_GROUP\n      cluster: default\n      username: ${NACOS_USERNAME:nacos}\n      password: ${NACOS_PASSWD:nacos}\n  \n# 端点配置\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n    jmx:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always',
        'eaf66b12f087ad235aaf0367c08e46c0', '2022-10-26 14:03:39', '2022-10-26 14:03:39', 'nacos', '172.21.0.1', 'U',
        '', ''),
       (27, 860, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/system-server/auth/**, /api-gateway/docapp/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '4ecbd5178ee0014e62ec44546b07d341', '2022-10-26 14:04:53', '2022-10-26 14:04:54', NULL, '172.21.0.13', 'U', '',
        ''),
       (27, 861, 'matrix-security', 'DEFAULT_GROUP', '',
        '!!com.matrix.properties.SecurityProperties\nwhiteUrls: [/api-gateway/docapp/**, /system-server/auth/**, /system-server/nacos/**,\n  /system-server/nacos/shared/**, /api-gateway/docApp/**, /system-server/resource/admin/**,\n  /system-server/resource/role/**]\n',
        '1131f9a8acc4fb16646785b1965a27a4', '2022-10-26 14:04:56', '2022-10-26 14:04:56', NULL, '172.21.0.2', 'U', '',
        '');
/*!40000 ALTER TABLE `his_config_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-26 14:12:53
