 ...
 */
@Slf4j
public class LocalTransactionExecuteImpl implements LocalTransactionExecuter {

    private TransactionExecuter transactionExecuter;

    public LocalTransactionExecuteImpl(TransactionExecuter transactionExecuter) {
