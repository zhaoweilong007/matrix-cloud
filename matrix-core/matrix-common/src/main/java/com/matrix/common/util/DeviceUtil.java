...
import com.matrix.common.model.DeviceInfo;
...
public class DeviceUtil {
    ...
    public DeviceInfo getDeviceInfo(String agent) {
        ...
        DeviceInfo deviceInfoDO = DeviceInfo.builder()
    ...
    //
    //		String userAgentStr = "Mozilla/5.0 (Linux; Android 10; LIO-AN00 Build/HUAWEILIO-AN00; wv) AppleWebKit/537.36
    // (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045713 Mobile Safari/537.36 MMWEBID/3189
    // MicroMessenger/8.0.11.1980(0x28000B51) Process/tools WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64";
    //
