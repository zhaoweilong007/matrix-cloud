...
public class WebFluxUtils {
     ...
     * @return Mono<Void>
     */
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, R<?> value) {
     ...
     * @return Mono<Void>
     */
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, HttpStatus status, R<?> r) {
        return webFluxResponseWriter(response, MediaType.APPLICATION_JSON_VALUE, status, r);
    }
