...
public class IpHashLoadBalancerClientFilter implements GlobalFilter, Ordered {
    ...
    public IpHashLoadBalancerClientFilter(
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (url != null
                && (CommonConstants.HASH_LB.equals(url.getScheme()) || CommonConstants.HASH_LB.equals(schemePrefix))) {
    ...
    private Mono<Response<ServiceInstance>> choose(ServerWebExchange exchange) {
        ...
        IpHashLoadBalancer loadBalancer = new IpHashLoadBalancer(
